...
class VibrationGenerator:
    def __init__(self, config):
        ...
        self.time = config.getfloat('time', 1, minval=0.1)
    ...
    def prepare_test(self, gcmd):
        ...
        self.time = gcmd.get_float("TIME", self.time, minval=1., maxval=60.)
...
class ResonanceGenerator:
    ...
    cmd_GENERATE_RESONANCES_help = ("Generates resonances for a specifed axis and frequency.")
